...
export const FiverIcon = ({ className, ...rest }) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="Fiverr--Streamline-Simple-Icons" height="24" width="24">
  <desc>
    Fiverr Streamline Icon: https://streamlinehq.com
  </desc>
  <title>Fiverr</title>
  <path d="M23.004 15.588a0.995 0.995 0 1 0 0.002 -1.99 0.995 0.995 0 0 0 -0.002 1.99zm-0.996 -3.705h-0.85c-0.546 0 -0.84 0.41 -0.84 1.092v2.466h-1.61v-3.558h-0.684c-0.547 0 -0.84 0.41 -0.84 1.092v2.466h-1.61v-4.874h1.61v0.74c0.264 -0.574 0.626 -0.74 1.163 -0.74h1.972v0.74c0.264 -0.574 0.625 -0.74 1.162 -0.74h0.527v1.316zm-6.786 1.501h-3.359c0.088 0.546 0.43 0.858 1.006 0.858 0.43 0 0.732 -0.175 0.83 -0.487l1.425 0.4c-0.351 0.848 -1.22 1.364 -2.255 1.364 -1.748 0 -2.549 -1.355 -2.549 -2.515 0 -1.14 0.703 -2.505 2.45 -2.505 1.856 0 2.471 1.384 2.471 2.408 0 0.224 -0.01 0.37 -0.02 0.477zm-1.562 -0.945c-0.04 -0.42 -0.342 -0.81 -0.889 -0.81 -0.508 0 -0.81 0.225 -0.908 0.81h1.797zM7.508 15.44h1.416l1.767 -4.874h-1.62l-0.86 2.837 -0.878 -2.837H5.72l1.787 4.874zm-6.6 0H2.51v-3.558h1.524v3.558h1.591v-4.874H2.51v-0.302c0 -0.332 0.235 -0.536 0.606 -0.536h0.918V8.412H2.85c-1.162 0 -1.943 0.712 -1.943 1.755v0.4H0v1.316h0.908v3.558z" fill="#ffffff" stroke-width="1"></path>
</svg>
);
...
export const CircularText = ({ className, ...rest }) => (
  ...
  >
    <defs>
      {/* Smaller radius = text closer to center */}
      <path
        id="circlePath"
        d="
          M 250,250
    ...
    >
      <textPath
        ...
        textAnchor="middle"
      >
        Rana Muzamil • Digital Marketing •
      </textPath>
    </text>
  </svg>
);
